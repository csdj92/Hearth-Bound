...
= 1.2.1 (Released: June 26, 2020) =
* Added: New Landscape and Portrait image size.
* Updated: Minor CSS with respect to Pro

= 1.2 (Released: May 12, 2020) =
...
= 1.1.9 (Released: April 23, 2020) =
* Bug Fixed: Padding issue when Header Video Active

= 1.1.8 (Released: March 03, 2020) =
* Bug Fixed: Data sanitization issue Number Range function

= 1.1.7 (Released: January 29, 2020) =
* Bug Fixed: Typo issue

= 1.1.6 (Released: January 20, 2020) =
* Removed: Demo Importer

= 1.1.5 (Released: January 16, 2020) =
* Added: Alternative Featured Image option for ECT Service when using ECT Pro

= 1.1.4 (Released: January 15, 2020) =
* Bug Fixed: h1 tag issue

= 1.1.3 (Released: November 15, 2019) =
* Bug Fixed: Header search missing closing span tag
* Removed: Unnecessary file icon-functions.php

= 1.1.2 (Released: July 30, 2019) =
* Bug Fixed: Pre, table, mark, ins color and font-size issue in editor-style
* Bug Fixed: Header video when no text issue
* Updated: Minor CSS with respect to Pro

= 1.1.1 (Released: June 13, 2019) =
